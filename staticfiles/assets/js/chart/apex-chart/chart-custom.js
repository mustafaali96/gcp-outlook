...
var options = {
    ...
    //     align: 'left'
    // },
    labels: ["2014-01-01", "2014-01-02", "2014-01-03", "2014-01-04", "2014-01-05"],
    xaxis: {
        type: 'datetime',
    },
    yaxis: {
...
var options1 = {
    ...
    xaxis: {
        type: 'date',
        categories: ["Aug 2018", "Sep 2018", "Oct 2018", "Nov 2018", "Dec 2018", "Jan 2019", "Feb 2019"],
    },
    tooltip: {
        x: {
...
//     }],
//     xaxis: {
//         categories: ['Windows', 'Linux', 'Android', 'Linux (Server)', 'Windows (Server)', 'Networking', 'IOT', 'Finance', 'Database'],
//     },
//     // colors:[ '#fd4b60', '#faaa1f', '#1c9efd', '#686cea', '#6cee4d', '#fe824c', '#d764ff', '#19d7fe', '#00f2a1' ]
//
// }
//
...
var chart3 = new ApexCharts(
    document.querySelector("#column-chart-copy"),
    options3
);
...
var options9 = {
    ...
    series: [33, 25, 15, 41, 15,10, 33, 20],
    labels: ['Windows', 'Linux', 'Android', 'Linux (Server)', 'Windows (Server)', 'Networking', 'IOT', 'Finance', 'Database'],
    legend: {
      show: true,
      position: 'bottom',
    },
    ...
    colors:['#dc3545', '#f8d62b', '#1d9dfe' , '#686bed', '#6bef4c', '#fe824c', '#d764fe', '#19d8ff' , '#00f2a1' ]
}
